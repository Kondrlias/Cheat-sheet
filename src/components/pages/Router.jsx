...
function YourRoutes() {  
  return (  
    <Routes>  
      ...
      <p>
        <b>Route:</b>Этот компонент определяет отдельный маршрут. Атрибут path
        указывает URL, а element — компонент, который будет рендериться.
      </p>
      <pre>
        <code>{`<Route path="/contact" element={<Contact />} />`}</code>
      </pre>
      <p>
        <b>Link:</b> Этот компонент используется для навигации между маршрутами.
        Он заменяет теги {`<a>`} в React-приложении.
      </p>
      <pre>
...
function Navigation() {  
  return (  
    <nav>  
      ...
      <p>
        <b>Outlet:</b> Этот компонент используется для рендеринга вложенных
        маршрутов. Он позволяет создавать иерархическую навигацию.
      </p>
      <pre>
...
function Layout() {  
  return (  
    <div>  
      ...
      <h2>Основные хуки</h2>
      <p>
        <b>useParams:</b> Используется для извлечения параметров URL в
        компонентах маршрутов.
      </p>
      <pre>
...
function User() {  
  ...
  return <h2>User ID: {userId}</h2>;  
      ...
      <p>
        <b>useNavigate:</b> Позволяет программно изменять маршрут. Это может
        быть полезно для навигации после выполнения действий.
      </p>
      <pre>
...
function CurrentLocation() {  
  ...
  return <div>Current location: {location.pathname}</div>;  
      ...
      <p>
        <b>useLocation: </b> Предоставляет информацию о текущем URL, такой как
        pathname и состояние.
      </p>
      <pre>
        <code>{`import { useLocation } from 'react-router-dom';  
...
function CurrentLocation() {  
  ...
  return <div>Current location: {location.pathname}</div>;  
      ...
      <p>
        <b>useRoutes:</b> Позволяет определять маршруты в виде массива, что
        может быть удобно для управления маршрутами в более сложных приложениях.
      </p>
      <pre>
